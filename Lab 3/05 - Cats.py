...
MyLib.oval(x0 + d * 1.2 * size, y0 + size / 6, size * 2 / 3, 5, d * pi / 6)
MyLib.oval(x0, y0, size, 2, 0)
MyLib.oval(x0 + d * 0.8 * size, y0 + size / 4, size / 4, 1, 0)
MyLib.oval(x0 - d * 0.8 * size, y0 + size / 3, size / 4, 2, 0)
MyLib.oval(x0 + d * (0.8 * size + size/5), y0 + size / 4 + size/3, size / 4, 3, pi /2)
...
MyLib.oval(x1 - d *  head * sin(pi / 4), y1 + head * cos(pi / 4) / 1.5, size/4, 3, pi / 2)
